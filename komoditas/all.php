...
if($jwt){
    ...
    try {
        ...
        if($num>0){
            // komoditas array
            $komoditas_arr=array();
            $komoditas_arr["list_komoditas"]=array();
            ...
            while ($row = $stmt->fetch(PDO::FETCH_ASSOC)){
                ...
                array_push($komoditas_arr["list_komoditas"], $komoditas_list);
            }
            ...
            echo json_encode($komoditas_arr);
        }
        ...
        // no products found will be here
            ...
            echo json_encode(
                array("message" => "Tidak ada daftar komoditas.")
            );
        }
    }
